...
export default function SzallitasPage(){
    ...
    return(
        <div className="flex min-h-screen flex-col items-center space-y-6 bg-pink-300 p-6 text-pink-950">
            <h1 className="text-3xl font-bold">Szállítás</h1>
            <div className="w-full max-w-lg rounded-2xl bg-pink-400 p-2 shadow-md">
          ...
          {dobozok.map((e, i) => (
            <div key={i}>
              ...
              <div className="h-3 rounded-full bg-blue-200 shadow-md">
                <div
                  className="h-3 rounded-full bg-pink-950"
